...
public class DeleteMember implements Servlet {
	...
	public void destroy() {
		...
		this.config = null;
		this.sc = null;
		System.out.println("Destryoing the servlet object for delete member");
	}
	...
	public void service(ServletRequest arg0, ServletResponse arg1) throws ServletException, IOException {
		...
		try {
			this.dbaccess.deleteMember(Integer.parseInt(arg0.getParameter("id")));
			hrs.sendRedirect("viewmembers");
		}
		catch(SQLException e) {
